 ...
 * $Revision: 2 $
 * $Date: 16/02/2216:24 $
 * @brief    PN020 series I2C driver source file
 *
 * @note
...
uint32_t I2C_Open(I2C_T *i2c, uint32_t u32BusClock)
{
    ...
    u32Div = (uint32_t) ((SystemCoreClock+u32BusClock)/(u32BusClock *4) - 1); /* Compute proper divider for I2C clock */
    if(u32Div>0xff)   u32Div = 0xff;         
    i2c->CLKDIV = u32Div;
...
/**
  * @brief Set the I2C bus clock. Only available in Master mode.
  * @param[in] i2c is the base address of I2C module.
  * @param[in] u32BusClock is the target bus speed of I2C module.
  * @return Actual I2C bus clock frequency.
  */
