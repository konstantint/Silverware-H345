 ...
 * $Revision: 2$
 * $Date: 16/02/25 10:23 $
 * @brief    PN020 series WWDT driver header file
 *
 * @note
...
/** @addtogroup PN020_WWDT_EXPORTED_CONSTANTS WWDT Exported Constants
  @{
*/
...
/*@}*/ /* end of group PN020_WWDT_EXPORTED_CONSTANTS */
...
/**
  * @brief This macro clear WWDT compare match event flag.
  * @param None
  * @return None
  * \hideinitializer
  */
#define WWDT_CLEAR_WWDTF_FLAG() (WWDT->STATUS = WWDT_STATUS_WWDTF_Msk)
...
/**
  * @brief This macro is used to indicate WWDT compare match event flag.
  * @return WWDT compare match interrupt occurred or not
  * @retval 0 WWDT compare match interrupt did not occur
  * @retval 1 WWDT compare match interrupt occurred
  * \hideinitializer
  */
#define WWDT_GET_WWDTF_FLAG() (WWDT->STATUS & WWDT_STATUS_WWDTF_Msk ? 1 : 0)
