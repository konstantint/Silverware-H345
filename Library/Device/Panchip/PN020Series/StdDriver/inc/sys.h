 ...
 * $Revision: 15 $
 * $Date: 15/06/04 5:18p $ 
 * @brief    PN020 series SYS driver header file
 *
 * @note
...
/** @addtogroup PN020_SYS_Driver SYS Driver
  @{
*/

/** @addtogroup PN020_SYS_EXPORTED_CONSTANTS SYS Exported Constants
  @{
*/    
/*---------------------------------------------------------------------------------------------------------*/
...
#define SYS_BODCTL_BODVL_2_4V             (1UL<<SYS_BODCTL_BODVL_Pos)     /*!< Setting Brown Out Detector Threshold Voltage as 2.4V */
...
#define SYS_MFP_P02_Msk              0x00000404UL     /*!< General purpose digital I/O pin.                 */ 
...
#define SYS_MFP_P03_Msk              0x00000808UL
...
#define SYS_MFP_P10_TEST_DAT         0x00000100UL     /*!< TEST_DAT input pin.                              */ 
...
#define SYS_MFP_P11_SPI1_CLK         0x00000002UL     /*!< SPI0 serial clock pin.                           */ 
...
#define SYS_MFP_P50_PWM0_CH7         0x01000000UL     /*!< PWM0 channel7 output/capture input.              */ 
#define SYS_MFP_P50_Msk              0x01000101UL     /*!< P5_MFP pin 0 mask                                */ 
...
#define SYS_MFP_P51_PWM0_CH6         0x02000000UL     /*!< PWM0 channel6 output/capture input.              */ 
#define SYS_MFP_P51_Msk              0x02000202UL     /*!< P5_MFP pin 1 mask                                */ 
...
#define SYS_MFP_P53_TEST_CLK         0x00000800UL     /*!< TEST_CLK input pin.                              */ 
...
#define SYS_MFP_P54_TM2_TADC_DATL    0x00001000UL
...
#define SYS_MFP_P55_SPI0_SS          0x00002000UL     /*!< 1st SPI0 slave select pin.                       */ 
...
#define SYS_MFP_P56_Msk              0x00004040UL     /*!< P5_MFP pin 6 mask                                */ 
...
/*@}*/ /* end of group PN020_SYS_EXPORTED_CONSTANTS */

/** @addtogroup PN020_SYS_EXPORTED_FUNCTIONS SYS Exported Functions
  @{
*/
/**
...
/**
  ...
  */
#define SYS_ENABLE_LVR_RST()            (SYS->BODCTL &= ~SYS_BODCTL_PDLVR_Msk)
/**
...
#define SYS_DISABLE_LVR_RST()            (SYS->BODCTL |= SYS_BODCTL_PDLVR_Msk)
...
/*@}*/ /* end of group PN020_SYS_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group PN020_SYS_Driver */
