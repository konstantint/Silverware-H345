 ...
 * $Revision: 2 $
 * $Date: 16/02/26 12:39 $
 * @brief    PN020 series FMC driver header file
 *
 * @note
...
/** @addtogroup PN020_FMC_Driver FMC Driver
  @{
*/

/** @addtogroup PN020_FMC_EXPORTED_CONSTANTS FMC Exported Constants
  @{
*/
/*---------------------------------------------------------------------------------------------------------*/
/* Define Base Address                                                                                     */
...
#define FMC_APROM_CRC_BASE    0X0000
#define FMC_LDROM_CRC_BASE    0X7400
#define FMC_SPROM_CRC_BASE    0X7C00
/*---------------------------------------------------------------------------------------------------------*/
...
/*@}*/ /* end of group PN020_FMC_EXPORTED_CONSTANTS */

/** @addtogroup PN020_FMC_EXPORTED_FUNCTIONS FMC Exported Functions
  @{
*/
...
/*@}*/ /* end of group PN020_FMC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group PN020_FMC_Driver */
