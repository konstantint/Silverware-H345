 ...
 * $Revision: 2 $
 * $Date: 16/02/25 17:21 $ 
 * @brief    PN020 series GPIO driver header file
 *
 * @note
...
/** @addtogroup PN020_GPIO_Driver GPIO Driver
  @{
*/

/** @addtogroup PN020_GPIO_EXPORTED_CONSTANTS GPIO Exported Constants
  @{
*/
...
/*@}*/ /* end of group PN020_GPIO_EXPORTED_CONSTANTS */

/** @addtogroup PN020_GPIO_EXPORTED_FUNCTIONS GPIO Exported Functions
  @{
*/
...
/*@}*/ /* end of group PN020_GPIO_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group PN020_GPIO_Driver */
