 ...
 * $Revision: 2 $
 * $Date: 16/02/25 16:48 $
 * @brief    PN020 series Analog Comparator(ACMP) driver header file
 *
 * @note
...
/** @addtogroup PN020_ACMP_EXPORTED_CONSTANTS ACMP Exported Constants
  @{
*/
...
/*@}*/ /* end of group PN020_ACMP_EXPORTED_CONSTANTS */
...
/**
  * @brief This macro is used to get ACMPF  flag
  * @param[in] acmp The base address of ACMP module
  * @param[in] u32ChNum The ACMP number, ether 0 or 1
  * @return   ACMPF event occurred or not
  * \hideinitializer
  */
#define ACMP_GET_ACMPF_FLAG(acmp, u32ChNum) (ACMP->STATUS & (ACMP_STATUS_ACMPF0_Msk<<(u32ChNum))?1:0)

/**
  * @brief This macro is used to clear ACMPF flag
  * @param[in] acmp The base address of ACMP module
  * @param[in] u32ChNum The ACMP number, ether 0 or 1
  * @return   None
  * \hideinitializer
  */
#define ACMP_CLR_ACMPF_FLAG(acmp, u32ChNum) (ACMP->STATUS = (ACMP_STATUS_ACMPF0_Msk<<(u32ChNum)))
